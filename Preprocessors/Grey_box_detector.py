...
def find_bounding_boxes(pdf_path):
    ...
    print(f"Detected bounding boxes: found {len(filtered_contours)}")
...
#find_bounding_boxes(r"C:\Users\jonch\Downloads\131101-WIP12-DR-S-5123 & 5124_commented_20250414 1 (1).pdf")
